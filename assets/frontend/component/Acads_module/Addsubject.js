...
class Addsub extends Component {
   constructor(props) {
          super(props);
            ...
            this.state = {
                 classvalue:'',sectionvalue:'',Faculty:'',  selected: [],sorted: 'asc',_id:'', name:''
                };
      ...
      <h2> Add Subject </h2>
        ...
        />
         ...
         <Table multiSelectable onRowSelect={this.handleRowSelect} style={{ marginTop: 10 }}>
          ...
          <Button  icon='done' label='Delete selected Subject And faculty assignment' onClick={this.DeleteDoc} accent raised/>
      </Card>
      </div>
    );
  }

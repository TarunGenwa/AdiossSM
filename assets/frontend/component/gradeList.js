...
handleChange = (name, value) => {
  ...
  render () {
    ...
    return (
      ...
      <Card>
        <Input type='number' label='Lower Limit percent' name='lowerLimit '  icon='number' value={this.state.lowerLimit} onChange={this.handleChange.bind(this, 'lowerLimit')} />
        <Input type='number' label='Upper Limit percent' name='UpperLimit' icon='Number' value={this.state.UpperLimit} onChange={this.handleChange.bind(this, 'UpperLimit')} />
        <Input type='text' label='Grade' name='grade' icon='A' value={this.state.grade} onChange={this.handleChange.bind(this, 'grade')} />
        <Button  label='Add Entry' onClick={this.handleClickButton} accent raised/>

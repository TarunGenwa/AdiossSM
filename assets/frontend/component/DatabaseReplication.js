...
var student_data=[],student_id_data=[],student_attendance=[],fee_data=[];
PouchDB.plugin({
  loadIt: load.load
});
  ...
  render () {
    ...
    return (
      <div style={{ flex: 1, overflowX: 'auto', margin: '5% 10% 10% 20%' }}>
        ...
        <MenuDivider />
        <h3> Online </h3>
        <Button  label='Backup' onClick={this.firebasefunc} accent />
        <Button  label='Restore' onClick={this.firebaseRead}  />
